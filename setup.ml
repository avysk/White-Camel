...
(* OASIS_START *)
(* DO NOT EDIT (digest: b936eb2724b0618c011468f699adcd05) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "enable build of curses interface";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "whiteengine"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "whitecamel.ml"});
               Executable
                 ({
                     cs_name = "poseator";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "ui", true);
                           (OASISExpr.ENot (OASISExpr.EFlag "ui"), false)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/tools";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "whiteengine";
                           FindlibPackage ("curses", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "poseator.ml"});
               Doc
                 ({
                     cs_name = "whiteengine";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "\"Whiteengine documentation\"";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\018\221\173v\002e\153\029\201R\189O\227%\173\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
